...
/**
 * retrives all the tickets from the database
 * @returns an array of objects listing all the ticket information
 *
 */
...
/**
 * 
 * @param {Object} ticketList is an object with the properties:  name, question, roomNumber, problem, description, code, errorLog
 */
...
/**
 * 
 * @param {Integer} id is automatically generated by the datbase
 * @param {Object}  ticketList is an object with the properties:  name, question, roomNumber, problem, description, code, errorLog
 * @returns updated ticket with any new information
 */
...
/**
 * 
 * @param {*} id is automatically generated by the datbase
 * @returns the new table omitting the deleted objects.  
 */
